...
const ExchangeCard = ({ name, toothName, exchangeWith, notes, contact, createdAt, imageSrc, isFavExchange, id }) => {
    return (
        <div className="bg-white rounded-lg shadow-md p-3 w-full md:w-[500px] lg:w-[35%] relative">
